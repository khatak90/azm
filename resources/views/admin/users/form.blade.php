    ...
    <form method="POST" action="{{ route('admin.saveUser') }}" id="userForm">
      ...
      <div class="form-group col-md-4">
          ...
          <div>
              ...
              <div class="checkbox-custom checkbox-default checkbox-inline">
                <input type="checkbox" id="inputCheckboParent" name="roles[]" value="parent" @if($user->id &&  $user->hasRole('parent')) checked @endif>
                <label for="inputCheckboxParent">Parent</label>
              </div>
              <div class="checkbox-custom checkbox-default checkbox-inline">
                <input type="checkbox" id="inputCheckboPrincipal" name="roles[]" value="principal" @if($user->id &&  $user->hasRole('principal')) checked @endif>
                <label for="inputCheckboxPrincipal">Principal</label>
              </div>
