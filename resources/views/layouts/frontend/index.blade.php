...
<html>
    ...
    <nav class="navbar navbar-default fixed-top">
        <div class="row" style="flex-grow: 1;">
            ...
            <div class="col-md-2 col-lg-5 col-xl-5 d-none d-md-block">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 col-xl-3 d-none d-sm-block">
                ...
                &nbsp;
                &nbsp;
                @if(Auth::check() && !Auth::user()->hasRole('parent') && !Auth::user()->hasRole('admin')&& !Auth::user()->hasRole('parent'))
                <span class="become-instructor" href="{{ route('become-parent') }}" data-toggle="modal" data-target="#myModal1">Become Parent</span>
                @endif
            </div>
    ...
    <div class="modal" id="myModal1">
        <div class="modal-dialog">
          ...
          <div class="becomeInstructorForm">
             <form id="becomeInstructorForm" class="form-horizontal" method="POST" action="{{ route('become-parent') }}">
              {{ csrf_field() }}
                  <div class="px-4 py-2">
                      <div class="form-group">
                          <div class="row">
